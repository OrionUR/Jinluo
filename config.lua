...
CONFIG = {}                         -- 配置变量
CONFIG.Debug = 1                    -- 输出调试和错误信息，0 不输出，1 输出信息在debug.txt到当前目录
...
CONFIG.bpp = 32                     -- 全屏时像素色深，一般为16或者32
                                    ...
                                    -- 24位未经过测试，不保证正确显示
CONFIG.FullScreen = 0               -- 启动时是否全屏，0 窗口，1 全屏
CONFIG.EnableSound = 1              -- 是否打开声音，0 关闭，1 打开，关闭了在游戏中无法打开
CONFIG.XScale = 18                  -- 贴图宽度的一半
CONFIG.YScale = 9                   -- 贴图高度的一半
CONFIG.CharSet = 0                  -- 游戏字体，0简体，1繁体
CONFIG.LargeMemory = 1              -- 设置内存使用方式，0 少使用内存，1 多使用内存
CONFIG.PlayName = "小虾米"              -- 主角的名字
...
CONFIG.Softener = 1                 -- 场景柔化，0 不柔化，1 柔化
CONFIG.Bj = 1                       -- 暴击震动，0 不动，1 动
